...
function isOusideMinMax(dayMoment, minDate, maxDate, format) {
    return (
        (minDate && dayMoment.isBefore((0, _utilsParseInputJs2["default"])(minDate, format, "startOf"))) ||
        (maxDate && dayMoment.isAfter((0, _utilsParseInputJs2["default"])(maxDate, format, "endOf")))
    );
}
    ...
    _createClass(Calendar, [
        ...
        },
        {
            ...
            value: function renderMonthAndYear(classes) {
                ...
                month =
                    lang && _LangDicJs2["default"][lang] && _LangDicJs2["default"][lang][monthLower]
                        ? _LangDicJs2["default"][lang][monthLower]
                        : month;
                    ...
                    showMonthArrow
                        ? _react2["default"].createElement(
                              "button",
                              {
                                  ...
                                  style: onlyClasses
                                      ? undefined
                                      : _extends({}, styles["MonthButton"], { float: "left" }),
                              ...
                              _react2["default"].createElement("i", {
                                  style: onlyClasses
                                      ? undefined
                                      : _extends({}, styles["MonthArrow"], styles["MonthArrowPrev"])
                              })
                          )
                        : null,
                    _react2["default"].createElement(
                        "span",
                        null,
                        _react2["default"].createElement("span", { className: classes.year }, year),
                        _react2["default"].createElement("span", { className: classes.monthAndYearDivider }, "年"),
                        _react2["default"].createElement("span", { className: classes.month }, month)
                    ),
                    showMonthArrow
                        ? _react2["default"].createElement(
                              "button",
                              {
                                  ...
                                  style: onlyClasses
                                      ? undefined
                                      : _extends({}, styles["MonthButton"], { float: "right" }),
                              ...
                              _react2["default"].createElement("i", {
                                  style: onlyClasses
                                      ? undefined
                                      : _extends({}, styles["MonthArrow"], styles["MonthArrowNext"])
                              })
                          )
                        : null
                );
        ...
        },
        {
            ...
            value: function renderWeekdays(classes) {
                ...
                for (var i = dow; i < 7 + dow; i++) {
                    ...
                    day =
                        lang && _LangDicJs2["default"][lang] && _LangDicJs2["default"][lang][dayLower]
                            ? _LangDicJs2["default"][lang][dayLower]
                            : day;
                    weekdays.push(
                        _react2["default"].createElement(
                            "span",
                            {
                                style: onlyClasses ? undefined : styles["Weekday"],
        ...
        },
        {
            ...
            value: function renderDays(classes) {
                ...
                return days.map(function(data, index) {
                    ...
                    var isSpecialDay =
                        specialDays &&
                        specialDays.some(function(specialDay) {
        ...
        },
        {
            ...
            value: function render() {
                ...
                return _react2["default"].createElement(
                    ...
                    _react2["default"].createElement("div", { className: classes.days }, this.renderDays(classes))
                );
            }
        }
    ]);
...
Calendar.propTypes = {
    ...
    minDate: _propTypes2["default"].oneOfType([
        _propTypes2["default"].object,
        _propTypes2["default"].func,
        _propTypes2["default"].string
    ]),
    maxDate: _propTypes2["default"].oneOfType([
        _propTypes2["default"].object,
        _propTypes2["default"].func,
        _propTypes2["default"].string
    ]),
    ...
    link: _propTypes2["default"].oneOfType([
